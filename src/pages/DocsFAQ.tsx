...
const DocsFAQ = () => {
      ...
      questions: [
        {
          ...
          answer: "Starter ($24/mo or $240/year) for up to $10k monthly Amazon payout, Growing ($59/mo or $590/year) for up to $50k, and Professional ($89/mo or $890/year) for up to $100k. All plans include unlimited vendors, unlimited transactions, AI forecasting, and transaction matching. Growing adds AI insights and buying opportunities. Professional adds automated notifications and scenario planning. Yearly plans save ~17%."
        },
        {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>FAQ - Amazon Cashflow Management Questions | Auren</title>
        <meta name="description" content="Frequently asked questions about Auren's amazon cashflow management software. Get answers about marketplace cash flow forecasting, integrations, and billing." />
        <meta name="keywords" content="amazon cashflow faq, marketplace cash flow questions, cashflow management help" />
        <link rel="canonical" href="https://aurenapp.com/docs/faq" />
      </Helmet>
      {/* Header */}
