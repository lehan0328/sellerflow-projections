...
const FlexReport = () => {
  ...
  return <div className="h-screen overflow-auto bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 p-2 md:p-4 relative">
      {/* Animated background grid */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#3b82f620_1px,transparent_1px),linear-gradient(to_bottom,#3b82f620_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000,transparent)]" />
      ...
      <div className="max-w-3xl mx-auto scale-[0.85] origin-top relative z-10">
        ...
        {/* Flex Report Card */}
        <Card ref={reportRef} className="relative overflow-hidden bg-white shadow-2xl border border-blue-200 backdrop-blur-xl">
          {/* Animated gradient orbs */}
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-blue-100/40 to-cyan-100/40 rounded-full blur-3xl animate-pulse" />
          <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-gradient-to-tr from-blue-100/30 to-indigo-100/30 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
          
          {/* Tech grid overlay */}
          <div className="absolute inset-0 bg-[linear-gradient(to_right,#3b82f620_1px,transparent_1px),linear-gradient(to_bottom,#3b82f620_1px,transparent_1px)] bg-[size:2rem_2rem]" />
          
          {/* Auren Watermark with glow */}
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
            <img src={aurenLogo} alt="" className="w-[600px] opacity-[0.04] select-none rotate-[-15deg] scale-110 drop-shadow-[0_0_40px_rgba(59,130,246,0.2)]" />
          </div>
          
          <div className="relative z-10 p-3 md:p-4">
            {/* Header with Branding */}
            <div className="flex items-center justify-between mb-4 pb-4 border-b border-blue-200 relative">
              <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-blue-400 to-transparent" />
              <div>
                <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-blue-600 via-cyan-600 to-blue-600 bg-clip-text text-transparent mb-2 tracking-tight drop-shadow-[0_0_10px_rgba(59,130,246,0.3)]">
                  Financial Power Report
                </h1>
                <p className="text-blue-600/80 text-sm mb-1">Your business at a glance</p>
              ...
              <div className="text-center flex flex-col items-center">
                <div className="relative">
                  ...
                  <img src={aurenLogo} alt="Auren" className="h-12 md:h-14 drop-shadow-[0_0_15px_rgba(59,130,246,0.5)] mb-1 relative" />
                </div>
                <p className="text-lg font-black bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent mb-1">Auren</p>
                <p className="text-xs font-semibold text-blue-600">www.aurenapp.com</p>
              </div>
            </div>

            {/* Verified Timestamp */}
            <div className="mb-4 flex items-center justify-center gap-2 bg-blue-50/80 backdrop-blur-md rounded-xl p-3 border border-blue-200 shadow-lg shadow-blue-200/50">
              <div className="flex items-center gap-2 px-3 py-1.5 bg-white/80 rounded-lg border border-cyan-200 backdrop-blur-sm">
              ...
              <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-white/80 rounded-lg border border-blue-200 backdrop-blur-sm">
                <Lock className="w-3 h-3 text-blue-600" />
                <span className="text-xs font-bold text-blue-700">Locked</span>
              </div>
            </div>

            {/* Primary Metric - Available to Spend */}
            <div className="mb-4 text-center bg-gradient-to-br from-blue-50 to-cyan-50 backdrop-blur-xl rounded-2xl p-5 border border-blue-300 shadow-2xl shadow-blue-300/30 relative overflow-hidden">
              {/* Animated glow */}
              <div className="absolute inset-0 bg-gradient-to-r from-blue-200/0 via-blue-200/20 to-blue-200/0 animate-pulse" />
              
              <div className="absolute top-3 right-3 flex items-center gap-1.5 px-3 py-1.5 bg-cyan-100/60 border border-cyan-400 rounded-full backdrop-blur-sm">
                <div className="w-1.5 h-1.5 bg-cyan-600 rounded-full animate-pulse shadow-[0_0_8px_rgba(8,145,178,0.8)]"></div>
                <span className="text-[10px] font-black text-cyan-700 uppercase tracking-wider">Live Verified</span>
              </div>
              <p className="text-xs text-blue-600/80 mb-2 uppercase tracking-widest font-semibold relative">Available to Spend</p>
              <div className={`text-4xl md:text-5xl font-black bg-gradient-to-r from-cyan-600 via-blue-600 to-cyan-600 bg-clip-text text-transparent mb-3 transition-all duration-300 leading-tight drop-shadow-[0_0_15px_rgba(59,130,246,0.3)] relative ${!visibility.safeSpending ? 'blur-lg' : ''}`}>
                {formatCurrency(safeSpendingData?.safe_spending_limit || 0)}
              </div>
              <p className="text-blue-600/70 text-xs font-medium mb-2 relative">Safe spending power for your business</p>
              
              {/* Reserve Amount Display */}
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/60 border border-blue-300 rounded-lg mb-3 backdrop-blur-sm relative">
                <DollarSign className="w-3 h-3 text-cyan-600" />
                <span className="text-xs font-semibold text-cyan-700">Reserve: {formatCurrency(reserveAmount)}</span>
              </div>
              ...
              <div className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white/60 border border-cyan-300 rounded-lg backdrop-blur-sm relative">
                <BadgeCheck className="w-3 h-3 text-cyan-600 drop-shadow-[0_0_6px_rgba(8,145,178,0.4)]" />
                <span className="text-xs font-bold text-cyan-700 uppercase tracking-wide">Verified by Live Bank Account</span>
              </div>
              <button
                onClick={() => toggleVisibility('safeSpending')}
                className="absolute bottom-4 right-4 p-2 rounded-lg hover:bg-blue-200/50 transition-colors z-10"
              >
            ...
            <div className="grid grid-cols-2 gap-3 mb-5">
              ...
              <div className="group bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-4 border border-blue-200 shadow-lg shadow-blue-200/30 hover:shadow-blue-300/40 hover:shadow-xl transition-all duration-300 backdrop-blur-xl relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-100/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                
                <div className="absolute top-3 right-3 flex items-center gap-1 px-2.5 py-1 bg-cyan-100/60 border border-cyan-300 rounded-full backdrop-blur-sm">
                  <div className="w-1 h-1 bg-cyan-600 rounded-full shadow-[0_0_6px_rgba(8,145,178,0.8)]"></div>
                  <span className="text-[10px] font-black text-cyan-700 uppercase tracking-wider">Verified</span>
                </div>
                <div className="flex items-center gap-2 mb-2 relative">
                  <div className="p-2 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl shadow-lg shadow-blue-400/30 group-hover:scale-110 group-hover:shadow-blue-400/50 transition-all duration-300">
                    <DollarSign className="w-4 h-4 text-white" />
                  </div>
                  <p className="text-xs font-semibold text-blue-600 uppercase tracking-wide">Max 90 Day Spending Power</p>
                </div>
                <p className={`text-2xl font-black bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent drop-shadow-[0_0_10px_rgba(59,130,246,0.3)] transition-all duration-300 relative ${!visibility.totalCash ? 'blur-lg' : ''}`}>{formatCurrency(max90DaySpendingPower)}</p>
                {showPercentageChange && (
              ...
              <div className="group bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-4 border border-blue-200 shadow-lg shadow-blue-200/30 hover:shadow-blue-300/40 hover:shadow-xl transition-all duration-300 backdrop-blur-xl relative overflow-hidden">
                ...
                <div className="flex items-center gap-2 mb-2 relative">
                  ...
                  <p className="text-xs font-semibold text-blue-600 uppercase tracking-wide">Available Credit</p>
                </div>
                <p className={`text-2xl font-black bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent drop-shadow-[0_0_10px_rgba(59,130,246,0.3)] transition-all duration-300 relative ${!visibility.availableCredit ? 'blur-lg' : ''}`}>{formatCurrency(totalAvailableCredit)}</p>
                {showPercentageChange && (
              ...
              <div className="group bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-4 border border-blue-200 shadow-lg shadow-blue-200/30 hover:shadow-blue-300/40 hover:shadow-xl transition-all duration-300 backdrop-blur-xl relative overflow-hidden">
                ...
                <div className="flex items-center gap-2 mb-2 relative">
                  ...
                  <p className="text-xs font-semibold text-blue-600 uppercase tracking-wide">Purchase Orders</p>
                </div>
                <p className={`text-2xl font-black bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent drop-shadow-[0_0_10px_rgba(59,130,246,0.3)] transition-all duration-300 relative ${!visibility.purchaseOrders ? 'blur-lg' : ''}`}>{formatCurrency(upcomingPurchaseOrders)}</p>
                {showPercentageChange && (
              ...
              {/* Amazon Revenue (30d) */}
              <div className="group bg-gradient-to-br from-cyan-50 to-blue-50 rounded-2xl p-4 border border-cyan-300 shadow-lg shadow-cyan-300/30 hover:shadow-cyan-400/50 hover:shadow-2xl transition-all duration-300 backdrop-blur-xl relative overflow-hidden ring-1 ring-cyan-300">
                ...
                <div className="absolute top-3 right-3 flex items-center gap-1 px-2.5 py-1 bg-cyan-100/70 border border-cyan-400 rounded-full backdrop-blur-sm">
                  <div className="w-1 h-1 bg-cyan-600 rounded-full animate-pulse shadow-[0_0_8px_rgba(8,145,178,1)]"></div>
                  <span className="text-[10px] font-black text-cyan-700 uppercase tracking-wider">Verified</span>
                </div>
                <div className="flex items-center gap-2 mb-2 relative">
                  <div className="relative">
                    <div className="absolute inset-0 bg-cyan-400/30 rounded-xl blur-md animate-pulse" />
                    <div className="p-2 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-xl shadow-lg shadow-cyan-400/40 group-hover:scale-110 group-hover:shadow-cyan-400/60 transition-all duration-300 relative">
                      <Zap className="w-4 h-4 text-white" />
                    </div>
                    <Sparkles className="absolute -top-1 -right-1 w-3 h-3 text-cyan-600 animate-pulse drop-shadow-[0_0_6px_rgba(8,145,178,0.8)]" />
                  </div>
                  <div className="flex flex-col">
                    <p className="text-xs font-semibold text-cyan-700 uppercase tracking-wide">Forecasted 90 Day Payout</p>
                    <span className="text-[9px] font-bold text-cyan-600 uppercase tracking-wider drop-shadow-[0_0_8px_rgba(8,145,178,0.4)]">Core Feature</span>
                  </div>
                </div>
                <p className={`text-2xl font-black bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(8,145,178,0.4)] transition-all duration-300 relative ${!visibility.amazonRevenue ? 'blur-lg' : ''}`}>{formatCurrency(forecasted90DayPayout)}</p>
                {showPercentageChange && (
              ...
              <div className="group bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-4 border border-blue-200 shadow-lg shadow-blue-200/30 hover:shadow-blue-300/40 hover:shadow-xl transition-all duration-300 backdrop-blur-xl relative overflow-hidden">
                ...
                <div className="flex items-center gap-2 mb-2 relative">
                  ...
                  <p className="text-xs font-semibold text-blue-600 uppercase tracking-wide">Total Amazon Payouts</p>
                </div>
                <p className={`text-2xl font-black bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent drop-shadow-[0_0_10px_rgba(59,130,246,0.3)] transition-all duration-300 relative ${!visibility.totalPayouts ? 'blur-lg' : ''}`}>{formatCurrency(totalPayouts)}</p>
                <p className="text-xs text-blue-600/70 mt-1 relative">
              ...
              <div className="group bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-4 border border-blue-200 shadow-lg shadow-blue-200/30 hover:shadow-blue-300/40 hover:shadow-xl transition-all duration-300 backdrop-blur-xl relative overflow-hidden">
                ...
                <div className="flex items-center gap-2 mb-2 relative">
                  ...
                  <p className="text-xs font-semibold text-blue-600 uppercase tracking-wide">Payout Growth Rate (1y)</p>
                </div>
                <p className={`text-2xl font-black ${payoutGrowthRate >= 0 ? 'bg-gradient-to-r from-cyan-600 to-blue-600' : 'bg-gradient-to-r from-red-500 to-orange-500'} bg-clip-text text-transparent drop-shadow-[0_0_10px_rgba(59,130,246,0.3)] transition-all duration-300 relative ${!visibility.payoutGrowthRate ? 'blur-lg' : ''}`}>
            ...
            {/* Footer */}
            <div className="pt-4 border-t border-blue-300 relative">
              ...
              <div className="flex items-center justify-center text-xs mb-3">
                <div className="text-center">
                  <p className="text-blue-600 font-semibold text-sm mb-1">
                    Powered by <span className="bg-gradient-to-r from-cyan-600 via-blue-600 to-cyan-600 bg-clip-text text-transparent font-black text-base drop-shadow-[0_0_10px_rgba(8,145,178,0.3)]">Auren</span>
                  </p>
                  <p className="text-xs font-bold text-blue-600">Cash Flow Management Software For Amazon Sellers</p>
                  <p className="text-xs font-semibold text-cyan-600 mt-1">www.aurenapp.com</p>
                </div>
              </div>
            </div>
          </div>
