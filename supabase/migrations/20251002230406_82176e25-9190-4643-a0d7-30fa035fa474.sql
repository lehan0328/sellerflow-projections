-- Add priority and cash_back fields to credit_cards table
-- Remove interest_rate and replace with cash_back
...
-- Add cash_back column (percentage)
ALTER TABLE public.credit_cards 
ADD COLUMN IF NOT EXISTS cash_back numeric DEFAULT 0 CHECK (cash_back >= 0 AND cash_back <= 100);
...
-- Update the simplified insert function to include new fields
