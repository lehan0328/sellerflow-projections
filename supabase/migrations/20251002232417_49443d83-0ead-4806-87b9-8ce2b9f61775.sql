...
DROP FUNCTION IF EXISTS public.insert_secure_credit_card_simple(text, text, text, numeric, numeric, numeric, text, text, text, text, text, numeric, date, date, numeric, numeric);
DROP FUNCTION IF EXISTS public.insert_secure_credit_card_simple(text, text, text, numeric, numeric, numeric, text, text, text, text, text, numeric, date, date, numeric, numeric, integer);

-- Create the correct version with cash_back and priority
