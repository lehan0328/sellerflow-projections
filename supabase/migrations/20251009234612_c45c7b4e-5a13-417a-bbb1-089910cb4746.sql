-- Drop and recreate encryption functions with SECURITY DEFINER
...
-- Recreate encrypt function with SECURITY DEFINER
...
-- Recreate decrypt function with SECURITY DEFINER
