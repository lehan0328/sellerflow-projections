...
SELECT cron.unschedule('scheduled-amazon-sync-hourly');

-- Create a cron job to sync Amazon data every 10 minutes
-- The edge function will handle the logic of when to actually sync
SELECT cron.schedule(
  'scheduled-amazon-sync-frequent',
  '*/10 * * * *', -- Every 10 minutes
  $$
  SELECT
    net.http_post(
