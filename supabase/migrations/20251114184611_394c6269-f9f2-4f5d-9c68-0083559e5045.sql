-- Increment referral code usage at signup to prevent abuse of limited-use codes
-- This updates handle_new_user() to immediately mark codes as used when trial starts
...
BEGIN
  ...
  IF NEW.raw_user_meta_data->>'referral_code' IS NOT NULL THEN
    ...
    -- CRITICAL: Increment referral code usage immediately at signup
    -- This prevents abuse of limited-use codes during trial periods
    -- Custom discount codes with max_uses=1 are now properly tracked
    PERFORM increment_referral_code_usage(NEW.raw_user_meta_data->>'referral_code');
  END IF;
