-- Stop auto-generating referral codes for new users
-- Users will manually generate codes via the "Generate Code" button when needed
...
BEGIN
  ...
  VALUES (
    ...
    v_account_id,
    NULL,  -- Changed: No longer auto-generate my_referral_code, users will generate manually via button
    v_referral_code,
    now(),
